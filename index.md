...
这里每天自动汇总技术圈、研究与 AI 领域的高价值动态，由 AI 评分筛选后生成中英双语速递。

> 项目基于 [Horizon](https://github.com/huangyuanyin/Horizon) 搭建，信息源和评分规则持续调整中。
...
A daily AI-curated digest covering tech, research, and AI community highlights. Scored and filtered by LLM, delivered in both Chinese and English.

> Built on top of [Horizon](https://github.com/huangyuanyin/Horizon). Sources and scoring rules are continuously tuned.
